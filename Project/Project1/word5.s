...
word5: 
	...
	/* Print the word one character at a time (no arrays yet) */
       ...
       cmp r11, #117		    /* letter u, ascii code = 117 */
       beq letter_u

       cmp r11, #98		    /* letter b, ascii code = 98 */
       beq letter_b

       cmp r11, #97		    /* letter a, ascii code = 87 */
       beq letter_a
	...
	sub r9, r9, #1
	b test
    letter_b:			    /* do this for every single character in the word */
	cmp r11, r6
	beq repeated
	mov r6, r11
	sub r9, r9, #1
